package com.example.studysync1.activities;
...
import com.example.studysync1.R;
import com.example.studysync1.database.NotesDatabase;
import com.example.studysync1.entities.Note;
...
public class CreateNote extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.getBooleanExtra("isViewOrUpdate", false)) {
        ...
        imageSave.setOnClickListener(new OnClickListener() {
            @Override
    ...
    private void showAddURLDialog() {
        if(dialogAddURL == null) {
            ...
            view.findViewById(R.id.textAdd).setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
            ...
            view.findViewById(R.id.textCancel).setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
                    dialogAddURL.dismiss();
                }
